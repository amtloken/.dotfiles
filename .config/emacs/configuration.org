...
- [[#global-settings][GLOBAL SETTINGS]]
  - [[#visit-emacs-configuration-document][Visit Emacs configuration document]]
...
* GLOBAL SETTINGS
** Visit Emacs configuration document
Shortkey =C-c e= to open the Emacs configuration:
#+begin_src emacs-lisp
...
* PROGRAMMING
I like for TAB to equal four spaces.
#+begin_src emacs-lisp
  (setq-default tab-width 4)
#+end_src
Show CamelCase symbols as distinct words everywhere
#+begin_src emacs-lisp
(use-package subword
  :config
...
Navigate JSON documents hierarchically using =json-navigator-navigate-after-point=.
#+begin_src emacs-lisp 
(use-package json-navigator
  :commands (json-navigator-navigate-after-point))
#+end_src
** Emacs Lisp
Use =eldoc-mode= to show documentation.
#+begin_src emacs-lisp
(use-package eldoc
  :hook
